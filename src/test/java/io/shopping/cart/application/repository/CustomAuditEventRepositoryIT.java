package io.shopping.cart.application.repository;

import io.shopping.cart.application.ShoppingCartAplicationApp;
import io.shopping.cart.application.config.Constants;
import io.shopping.cart.application.config.audit.AuditEventConverter;
import io.shopping.cart.application.domain.PersistentAuditEvent;
...
import static io.shopping.cart.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
